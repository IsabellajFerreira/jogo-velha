...
RM99843 - Felipe Zambello Silva
RM552329 - Isabella Jorge Ferreira
1TDSPF
'''
    ...
    for linha in tabuleiro:
        for elemento in linha:
            if elemento == ' ':
                return False
    return True
def imprimirPontuacao(pontos_jogador, pontos_jogador2=None, pontos_maquina=None):
    if pontos_maquina is not None:
        print(f"Pontuação - Jogador 1 : {pontos_jogador}  Máquina: {pontos_maquina}")
    if pontos_jogador2 is not None:
            ...
            if posicaoValida(tabuleiro, linha, coluna):
                ...
                if vencedor:
                    ...
                    if vencedor == jogador:
                        ...
                        pontos_jogador2 += 1
                    imprimirPontuacao(pontos_jogador, pontos_jogador2=pontos_jogador2)
                    break
    ...
    while pontos_jogador < 3 and pontos_maquina < 3:
        ...
        while True:
            ...
            if vencedor:
                ...
                print(f"O jogador {vencedor} venceu!")
                pontos_jogador += 1
                imprimirPontuacao(pontos_jogador, pontos_maquina=pontos_maquina)
                break
